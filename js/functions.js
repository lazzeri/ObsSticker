...
function FetchEvent() {
    ...
    channel.bind('onPartnerSticker', function (data) {
        if (data.message != "undefined") {
            Animation(data.message.stageGifts[0].target, false, 0);
        }
    });
    ...
    channel.bind('onGift', function (data) {
        if (data.message != "undefined") {
            ...
            switch (data.message.stageGifts[0].giftId) {
                case(5):
                ...
                case(619):
                    ...
                    break;
                case(42):
                    let tipjarvalue = data.message.stageGifts[0].extraData.numOfLikes;
                    //Tip jars:
                    switch (tipjarvalue) {
                        case(200):
                            ...
                            break;
                        case(500):
                            loopGifts(tipJar500, 619, true, tipjarvalue, userId);
                            break;
                        case(1000):
                            loopGifts(tipJar1000, 619, true, tipjarvalue, userId);
                            break;
                        case(5000):
                            loopGifts(tipJar5000, 619, true, tipjarvalue, userId);
                            break;
                        case(10000):
                            loopGifts(tipJar10000, 619, true, tipjarvalue, userId);
                            break;
                        case(15000):
                            loopGifts(tipJar15000, 619, true, tipjarvalue, userId);
                            break;
                        case(25000):
                            loopGifts(tipJar25000, 619, true, tipjarvalue, userId);
                            break;
                        case(30000):
...
function TestSticker()
{
    ...
    switch(val)
    {
        ...
        case('TipJar15000'):
            ...
            break;
        case('TipJar25000'):
            loopGifts(tipJar25000, 619, true, 25000, userId);
            break;
        case('TipJar30000'):
